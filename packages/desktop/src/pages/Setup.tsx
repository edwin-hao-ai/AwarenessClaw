...
const __UNUSED = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'moonshot-v1-auto', label: 'Moonshot V1 Auto（自动选择）' },
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'doubao-1-5-thinking-pro-250415', label: '豆包 1.5 Thinking Pro' },
  ...
  {
    key: 'qianfan', name: '文心一言 / 百度千帆', emoji: '🏛️', tag: '百度',
    desc: 'ERNIE 系列，OpenAI 兼容',
    baseUrl: 'https://qianfan.baidubce.com/v2',
    models: [
      { id: 'ernie-4.0-8k', label: 'ERNIE 4.0 8K' },
      { id: 'ernie-speed-128k', label: 'ERNIE Speed 128K（快速）' },
      { id: 'ernie-3.5-8k-preview', label: 'ERNIE 3.5（预览）' },
    ],
    needsKey: true,
  },
  {
  ...
  {
    key: 'siliconflow', name: 'SiliconFlow 硅基流动', emoji: '🚀', tag: '🆓 $1 新用户',
    desc: '聚合多模型，新用户赠 $1',
